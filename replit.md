...
- **Shift Planning**: Calendar-based shift management with Day/Week/Month views, staff availability tracking, and shift assignment capabilities for admins and managers. Staff set availability by clicking on specific dates in a calendar view.
