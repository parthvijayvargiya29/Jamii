...
async function ensureSeedRecipes() {
  try {
    ...
    log("No recipes found — seeding recipes…", "seed");
    ...
    const recipes = [
      ...
      { id: "9ea5c66b-6295-43ea-b8d6-681aae3f63e5", name: "Apfel/Ananas", dish_base: null, instructions: "1/2 Sprudel Wasser\n1/2 Saft\n2 Trauben TK", category: "Schorle", diet: null, dish_sauce: null, timing_minutes: 5, post_type: "Bar", image_url: null },
      ...
      { id: "34707849-e8f6-44b9-9a19-3207feebc2ec", name: "Iced Latte", dish_base: null, instructions: "300ml Hafer Barista\n1 Matcha/Blue Spirulina/Golden Milk\nHonig / Agavendicksaft\nKokosmilch", category: "Lattes", diet: null, dish_sauce: null, timing_minutes: 7, post_type: "Bar", image_url: null },
      { id: "bf7046ec-2da8-44d6-8db0-075b6cc7670b", name: "Immortal Goddess", dish_base: null, instructions: "Mixer:\n150ml Haferdrink\n1 Banane Frisch\n1/2 Avocado\nHandfull Spinat\n1 spoon Erdnussbutter\n1 Vanille Protein\n\nToppings:\n1/4 Granola\nBlaubeeran\nWeintrauben\nApfel\nKokosrasplen\nMinze", category: "Bowls", diet: null, dish_sauce: null, timing_minutes: 7, post_type: "Bar", image_url: "/assets/images/immortal-goddess-bowl.png" },
      { id: "6f983277-f669-4f2b-872a-1cdfd1226b49", name: "Island Bowl", dish_base: null, instructions: "Mixer:\nFrozen Acai\n1 Banane TK\n4 Erdbeeran TK\nBlaubeeran\n\nToppings:\n1/2 Granola\nBanane\nErdbeeran\nWeintrauben\nBlaubeeran\nKokosrasplen\nMinze", category: "Bowls", diet: null, dish_sauce: null, timing_minutes: 7, post_type: "Bar", image_url: "/assets/images/island-bowl.png" },
      ...
      { id: "cbef5d0e-6da8-402c-b45d-4ac8bacaecfb", name: "Minze-Limette", dish_base: null, instructions: "1/2 Lemonade\n1/2 Sprudel\nMinze\nLimette", category: "Schorle", diet: null, dish_sauce: null, timing_minutes: 5, post_type: "Bar", image_url: null },
      { id: "01cb6c76-a673-4fba-83d1-70f69d3650a3", name: "Nature Detox", dish_base: null, instructions: "1 Sprudel\nMinze\nGurke\nLimette", category: "Schorle", diet: null, dish_sauce: null, timing_minutes: 5, post_type: "Bar", image_url: "/assets/images/nature-detox.png" },
      { id: "d3ac7717-f489-41fc-ad6d-1c00ff20e192", name: "Pacific Bowl", dish_base: null, instructions: "Mixer:\n90ml Ananassaft\n90ml Kokosmilch\n1 Mango TK\n1 Banane TK\n1 Blue Spirulina\n\nToppings:\n1/4 Granola\nMango\nWeintrauben\nApfel\nKokosrasplen\nMinze", category: "Bowls", diet: null, dish_sauce: null, timing_minutes: 7, post_type: "Bar", image_url: "/assets/images/pacific-bowl.png" },
      { id: "90c3028c-3e02-4edf-8631-c4ce78c6cdcb", name: "Peanut Protein", dish_base: null, instructions: "300ml Mandel Barista\n1 Vanille Protein\n1 Banane TK\n1 Erdnussbutter\n1 Ahorn Sirup", category: "Shakes", diet: null, dish_sauce: null, timing_minutes: 7, post_type: "Bar", image_url: "/assets/images/peanut-protein.png" },
      { id: "df03379a-03ee-4ebb-9958-9f129498b082", name: "Power Bowl", dish_base: null, instructions: "In a bowl; Joghurt\n\nToppings:\nBanane\nErdbeeran\nBlaubeeran\nWeintrauben\nGranola\nSchokoladenflocken\nApfelscheiben\nMinze", category: "Bowls", diet: null, dish_sauce: null, timing_minutes: 7, post_type: "Bar", image_url: "/assets/images/power-bowl.png" },
      { id: "72e50646-d32b-45b4-bcf1-38fddfc092f8", name: "Red Hummus Mezze", dish_base: "Red Hummus", instructions: null, category: "Bowl", diet: "Vegetarian", dish_sauce: "Joghurt", timing_minutes: 7, post_type: null, image_url: null },
      { id: "0f5f10bd-08fc-4cf4-8ba4-6e314a00495d", name: "Revitalise", dish_base: null, instructions: "300ml Apfelsaft\n1 Acai\n1 Banane TK\n4 Erdbeeran TK\n1 Kokosmilch", category: "Shakes", diet: null, dish_sauce: null, timing_minutes: 7, post_type: "Bar", image_url: null },
      { id: "a1e8a348-ae85-42ec-b4b8-a71348e82842", name: "Strawberry Protein", dish_base: null, instructions: "300ml Mandel Barista\n1 Vanille Protein\n1 Banane TK\n8 Erdbeeran TK\nGrain Syrup", category: "Shakes", diet: null, dish_sauce: null, timing_minutes: 7, post_type: "Bar", image_url: "/assets/images/strawberry-protein.png" },
      { id: "d828a2a7-8a96-44ef-9184-305653b878cb", name: "Sunkissed", dish_base: null, instructions: "150ml Ananassaft\n150ml Mandeldrink\n1 Vanille Protein\n1 Banane TK\n1 Mango TK\n1 Dragonfrucht TK\n1 Kokosmilch", category: "Shakes", diet: null, dish_sauce: null, timing_minutes: 7, post_type: "Bar", image_url: "/assets/images/sunkissed.png" },
      { id: "533e3a89-2cfd-4793-953f-30591003d389", name: "Sunset", dish_base: null, instructions: "2 Apfel\n2 Karotten\n1 Ingwer\n1 Zitrone", category: "Juices", diet: null, dish_sauce: null, timing_minutes: 7, post_type: "Bar", image_url: null },
      { id: "b5b7bced-3b8f-42ca-a248-62f6e5e6a5eb", name: "The OG", dish_base: null, instructions: "3 Orangen\n1 Ingwer\n1 Zitrone", category: "Juices", diet: null, dish_sauce: null, timing_minutes: 7, post_type: "Bar", image_url: "/assets/images/the-og.png" },
    ...
    log(`Seeded ${recipes.length} recipes`, "seed");
  } catch (err: any) {
